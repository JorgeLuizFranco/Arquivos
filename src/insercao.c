...
/**
 * 
 * Núcleo da funcionalidade 6. Insere um registro criminal no arquivo binário e atualiza o arquivo de índices
...
int insere_crime_binario(FILE* arq_bin, cabecalho_t* cabecalho, cabecalho_indice_t* cabecalho_indice, char* nome_campo, void*** dados, int tipoVar, int* num_dados, crime_t* crime) {
    ...
    // cria um dado para o arquivo de indices com a chaveBusca especificada pelo campo "nome_campo" do
    // registro crime e byteOffset com o byteoffset que sera inserido
